...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=16, num_filters2=512, num_filters3=128, kernel_size=5, dropout_rate=0.3156575257816647, num_classes=num_classes).to(device)
    optimizer = optim.Adam(model.parameters(), lr=0.0001847572792930044)
