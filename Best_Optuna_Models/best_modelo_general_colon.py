...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=128, num_filters3=256, kernel_size=4, dropout_rate=0.47299545874952154, num_classes=num_classes).to(device)
    optimizer = optim.Adam(model.parameters(), lr=0.001028670381992095)
