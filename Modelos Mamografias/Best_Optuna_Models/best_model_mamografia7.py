...
def train_model(device, train_loader, val_loader, class_counts):
    ...
    model = Net(num_filters1=128, num_filters2=128, num_filters3=128, num_filters4=128, num_filters5=128, kernel_size=4, dropout_rate=0.5, num_classes=num_classes).to(device)
