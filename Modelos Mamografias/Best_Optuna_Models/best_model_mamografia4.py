...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=256, num_filters3=256, num_filters4=256, num_filters5=256, kernel_size=3, dropout_rate=0.3, num_classes=num_classes).to(device)
