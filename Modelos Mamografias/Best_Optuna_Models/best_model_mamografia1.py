...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=512, num_filters3=1024, kernel_size=4, dropout_rate=0.3, num_classes=num_classes).to(device)
    optimizer = optim.Adam(model.parameters(), lr=0.0003701163660665632)
