...
class Net(nn.Module):
    def __init__(self, num_filters1, num_filters2, num_filters3, num_filters4,kernel_size, dropout_rate, num_classes, input_size=256):
        ...
        for _ in range(4):  # Dado que tenemos tres bloques de Conv + MaxPool
...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=256, num_filters3=512, num_filters4=512, kernel_size=3, dropout_rate=0.4711483566097797, num_classes=num_classes).to(device)
