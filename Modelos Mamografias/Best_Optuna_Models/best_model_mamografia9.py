...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=32, num_filters2=512, num_filters3=256, num_filters4=512, num_filters5=1024, kernel_size=4, dropout_rate=0.5, num_classes=num_classes).to(device)
