...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=256, num_filters3=512, num_filters4=512, num_filters5=512, kernel_size=5, dropout_rate=0.4, num_classes=num_classes).to(device)
