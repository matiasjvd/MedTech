...
def train_model(device, train_loader, val_loader, class_counts):
    num_classes = 2  # Actualizar según el número de clases
    model = Net(num_filters1=256, num_filters2=256, num_filters3=256, num_filters4=256, num_filters5=256, kernel_size=4, dropout_rate=0.5, num_classes=num_classes).to(device)
    optimizer = optim.Adam(model.parameters(), lr=0.001701163660665632)
